...
### Changed
- **Example Example Update**: Updated `example/parse_knxproj.dart` script to print Room information alongside Group Addresses accurately matching the new mapping.
